...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.23.0/docs/resources/publication
...
export class Publication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Publication that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.23.0/docs/resources/publication#import import section} in the documentation of this resource for the id to use
