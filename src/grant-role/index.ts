...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.24.0/docs/resources/grant_role
...
export class GrantRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrantRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.24.0/docs/resources/grant_role#import import section} in the documentation of this resource for the id to use
