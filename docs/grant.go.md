...
```go
import "github.com/cdktf/cdktf-provider-postgresql-go/postgresql/v11/grant"
...
| <code><a href="#@cdktf/provider-postgresql.grant.GrantConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.25.0/docs/resources/grant#id Grant#id}. |
